...
<script type="text/javascript" language="javascript">
	function validar()
	{
		...
		if(f.texto.value==0)
		{
			alert("Por favor ingrese algo en el campo del mensaje.");
			f.texto.value="";
			f.texto.focus();
			f.texto.className = f.className + " focus";
			return false;
		} else {
			f.texto.className = f.className - " focus";
		}
		...
		f.setAttribute("action","envio.php");
		f.submit();
	}
			...
			<div id="contenido">
			  <!-- InstanceBeginEditable name="Contenido" -->
				...
				<form id="signupform" name="signupform" method="post">
					<fieldset>
                    	<div style="padding:5px; background-color:#F4F4F4; margin-bottom:10px;-moz-border-radius: 10px; border-radius: 10px; -webkit-border-radius : 10px;">
                            <label style="padding-left:9px;">Destino de  su mensaje:</label>   
							<br>
							<br>
							  
					      <label><input type="radio" name="destino" value="ventas" id="destino" checked> Ventas</label>&nbsp;&nbsp;&nbsp;
								<label><input type="radio" name="destino" value="sugerencias" id="destino" /> 
								Sugerencias</label><span class="asteriscoRojo"> </span>
                            </div>
                        <div style="padding:5px; background-color:#F4F4F4; margin-bottom:10px;-moz-border-radius: 10px; border-radius: 10px; -webkit-border-radius : 10px;">
                    	...
                    	<p>
                    		<label>Apellido(s)<span class="asteriscoRojo"> *</span></label>
                    		</br>
                      <input name="apellidos" type="text" id="apellidos" style="width:95%" /></p>
						...
						<span class="asteriscoRojo"> *</span></br>
                        <textarea name="texto" cols="44" rows="6" id="texto"  style="width:95%" ></textarea></p>
                        <p><input type="checkbox" name="autoriza_newsletter" id="autoriza_newsletter">
                         <em><strong>Deseo recibir en mi correo informaci&oacute;n sobre avisos y promociones.</strong></em></p>
