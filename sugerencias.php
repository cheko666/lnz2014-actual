...
$titulo = "Buz&oacute;n de Sugerencias";

//require_once("recaptchalib.php");
//$publickey = "6LciQ-kSAAAAANvSm_x_mjS2xvquqbniitHEqlo5"; // you got this from the signup page
				...
				<form id="signupform" name="signupform" method="post">
					<fieldset>
                      ...
                      <textarea name="texto" cols="44" rows="6" id="texto"  style="width:95%" ></textarea></p>
                        ...
                        <input type="hidden" name="destino" value="sugerencias"/>
